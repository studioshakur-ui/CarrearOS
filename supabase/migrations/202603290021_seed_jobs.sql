...
begin
  ...
  (
    ...
    'full_time',
    'mid',
    $$You will design and implement cloud infrastructure for enterprise clients across the Gulf. Deep hands-on experience with AWS services is required. You will use Terraform for infrastructure as code, Docker and Kubernetes for container orchestration, and build CI/CD pipelines for automated delivery. Linux administration skills are essential. You will advise clients on cloud migration strategies and best practices.$$,
    'mock-accenture-cloud-engineer',
  ...
  (
    ...
    'full_time',
    'mid',
    $$du is modernising its internal platform engineering capabilities. As a DevOps Engineer you will maintain and improve our Docker and Kubernetes cluster infrastructure, build CI/CD automation, manage Jenkins pipelines, and support Linux-based systems. Ansible is used for configuration management. You will work closely with development teams to reduce friction in the deployment process and improve reliability.$$,
    'mock-du-devops-engineer',
  ...
  (
    ...
    'full_time',
    'lead',
    $$Tamara is the leading BNPL platform in Saudi Arabia. As Tech Lead you will guide a team of engineers building our consumer and merchant products in React and Node.js, all written in TypeScript. You will own system design decisions, set code quality standards, drive Docker-based deployment strategies on AWS, and balance technical debt with product velocity. Strong communication and mentorship skills are as important as technical depth.$$,
    'mock-tamara-tech-lead',
